...
(
    ...
    CONSTRAINT fk_pendencias_agente
        FOREIGN KEY (agente_id) REFERENCES usuarios (id),

    CONSTRAINT fk_pendencias_entrada
        FOREIGN KEY (entrada_id) REFERENCES entradas (id),

    CONSTRAINT fk_pendencias_estacao
        FOREIGN KEY (estacao_id) REFERENCES estacoes (id),

    CONSTRAINT fk_pendencias_pcd
        FOREIGN KEY (pcd_atendido_id) REFERENCES usuarios (id)
);